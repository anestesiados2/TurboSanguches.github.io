document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateCart() {
        ...
        cart.forEach(item => {
            ...
            quantityControls.querySelector('.decrease-quantity').addEventListener('click', () => decreaseQuantity(item.name));
            quantityControls.querySelector('.increase-quantity').addEventListener('click', () => increaseQuantity(item.name));
    ...
    function handleAddToCartClick(event) {
        const sandwichFrame = event.target.closest('.sandwich-frame');
        if (sandwichFrame) {
    ...
    function handleClearCartClick() {
        ...
        if (anyChecked) {
            ...
            cart = cart.filter(item => !document.querySelector(`.remove-checkbox[data-name="${item.name}"]`).checked);
        } else {
